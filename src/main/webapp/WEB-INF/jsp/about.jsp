...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <p>
                I love to code and explore new technologies. Currently, I'm entrenched in Java building web apps using
                the
            ...
            <p>
                ...
                more
                than just a pile of spaghetti code. On the server side, I've made a little Spring application serving up
                JSP
